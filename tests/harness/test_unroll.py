...
def _make_minimal_params(**overrides: object) -> Parameters:
    ...
    defaults = dict(
        ...
        rise_time=RiseTimeParameters(
            coefficient=2.3,
            shallow_factor=2.0,
            shallow_center_depth=6.5,
            shallow_half_width=1.5,
            slip_scaling_factor=1.0,
            deep_factor=2.0,
            deep_center_depth=17.5,
            deep_half_width=2.5,
        ),
        rise_time_perturbation=RiseTimePerturbation(
            level1_slip_correlation=0.9,
        ...
        rupture_time_perturbation=RuptureTimePerturbation(
            ...
            slope=-0.5,
            level1_sigma=1.0,
            level1_slip_correlation=0.8,
            level2_sigma=1.0e-10,
            level2_roughness_correlation=0.5,
            level2_lambda_max=5.0,
        ),
        hybrid_correlation_length=HybridCorrelationLength(
            enabled=False,
            kmodel=KModel.SUZUKI,
            factor=2.0,
            center_depth=6.5,
            center_depth_range=1.5,
            side_taper=0.08,
            shallow_weight_start=1.0,
            shallow_weight_end=0.0,
            deep_weight_start=0.0,
            deep_weight_end=1.0,
        ),
        aseismic=AseismicParameters(enabled=False, smooth=False, depth=10.0),
        finite_difference_rupture=FiniteDifferenceRupture(
            enabled=True,
            scale_speed_with_slip=False,
        ),
        segment_delay=SegmentDelay(
            enabled=False,
            boundary_zone_width=[],
            boundary_velocity_factor=[],
        ),
